...
theta3 = asin(-((a1*sin(theta)-c1)/b1))+pi; % Angle between coupler and horizontal passing through slider
d1 = a1*cos(theta) - b1*cos(theta3);  % Horizontal distance between crank pivot and slider 
...
theta4 = acos(((a2*cos(theta)+c2)/b2)); % Angle between coupler2 and vertical passing through rack
d2 = a2*sin(theta) - b2*sin(theta4);  % Vertical distance between crank pivot and rack. 
